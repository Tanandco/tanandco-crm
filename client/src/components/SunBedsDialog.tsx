  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-30 flex items-center justify-center">
        ...
        {typedText && (
          <div className="bg-pink-500/90 text-white px-4 py-2 rounded-l-full rounded-tr-full shadow-lg animate-in slide-in-from-right duration-700 -ml-16" style={{ textShadow: '0 0 10px rgba(0, 0, 0, 0.3)' }}>
