...
export default function IconSidebar() {
  ...
  return (
    <div 
      className="fixed left-0 top-0 w-screen h-16 backdrop-blur-lg z-50 flex flex-row items-center justify-center px-2 md:px-6 gap-3 md:gap-6 animate-gradient-border"
      style={{
