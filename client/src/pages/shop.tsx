          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {selfTanningItems.map((product) => (
                <div 
                  key={product.id}
                  className="bg-slate-900/40 backdrop-blur-sm rounded-xl p-4 border-0 transition-all shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgba(255,105,180,0.25)] hover:-translate-y-1"
